...
# Removed duplicate export endpoint - exports are now handled client-side in app.js
# This reduces server load and eliminates redundant PDF/Excel generation code
